...
public class EFCoreStorageImplement: IStorage
{
    ...
    private readonly EFCoreStorageOptions? _storageOptions;
    ...
    public EFCoreStorageImplement(string connectionString)
        : this(new EFCoreStorageOptions() { ConnectionString = connectionString })
    {
    ...
    public EFCoreStorageImplement(EFCoreStorageOptions options)
    {
        if (options == null)
        {
